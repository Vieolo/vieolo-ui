...
export default function Table(props) {
    ...
    return _jsxs("div", Object.assign({ className: "vieolo-table", style: style }, { children: [_jsx("div", Object.assign({ className: "vieolo-table__header-row", style: { gridTemplateColumns: props.columnGrid } }, { children: props.headers.map((h, i) => {
