...
export default function TitlePeriodCard(props) {
    ...
    return _jsx(Card, Object.assign({ borderRadius: props.borderRadius, elevation: props.elevation, padding: 'half', emphasis: props.emphasis, color: props.color, ariaLabel: props.ariaLabel }, { children: _jsxs("div", Object.assign({ className: "vieolo-title-period-card" }, { children: [_jsxs("div", Object.assign({ className: "vieolo-title-period-card__header" }, { children: [_jsxs("div", Object.assign({ className: "vieolo-title-period-card__header__text" }, { children: [_jsx(TypographyParagraphMedium, { text: props.title, ariaLabel: `${props.ariaLabel || props.title} title` }, void 0),
                                _jsxs("div", Object.assign({ className: "vieolo-title-period-card__header__text__date" }, { children: [_jsx(TypographyParagraphMedium, { text: `${difference} ${differenceText}`, fontWeight: "bold", ariaLabel: `${props.ariaLabel || props.title} day difference` }, void 0),
                                        _jsx(TypographyParagraphSmall, { text: `${finalStart.formatDate(props.dateDisplayFormat)} - ${finalEnd.formatDate(props.dateDisplayFormat)}`, ariaLabel: `${props.ariaLabel || props.title} dates` }, void 0)] }), void 0)] }), void 0),
                ...
                (props.description && state !== 'collapsed') &&
                    _jsxs("div", Object.assign({ className: "vieolo-title-period-card__description" }, { children: [_jsx(Spacer, { height: "half" }, void 0),
                            ...
                            _jsx(TypographyParagraphMedium, { text: props.description, ariaLabel: `${props.ariaLabel || props.title} description` }, void 0)] }), void 0)] }), void 0) }), void 0);
}
