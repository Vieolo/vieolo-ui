...
export default function InputSet(props) {
    ...
    return _jsxs("div", Object.assign({ className: `vieolo-input-set${props.disabled ? ' disabled' : ''}`, style: { width: width } }, { children: [(props.label || props.actionButton) &&
            ...
            _jsx(Input, { value: props.value, error: props.error, onChange: props.onChange, placeholder: props.placeholder || '', size: props.size, type: props.type, ariaLabel: props.ariaLabel || props.label, autoFocus: props.autoFocus, onKeyDown: props.onKeyDown }, void 0)] }), void 0);
}
