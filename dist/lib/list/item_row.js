...
export default function ItemRow(props) {
    ...
    return _jsx("div", Object.assign({ className: mainClassName }, { children: _jsxs("div", Object.assign({ className: contentClassName, onClick: () => {
                ...
                props.searchRow
                    ...
                    : _jsxs("div", Object.assign({ className: "vieolo-item-row__title-col" }, { children: [_jsx(TypographyParagraphMedium, { text: props.title || '', fontWeight: 'bold', color: props.selected ? color : undefined, colorType: props.selected ? 'text' : undefined }, void 0),
                            props.subTitle &&
                                _jsx(TypographyCaptionLarge, { text: props.subTitle, showTitle: true, color: props.selected ? color : undefined, colorType: props.selected ? 'text' : undefined }, void 0)] }), void 0),
