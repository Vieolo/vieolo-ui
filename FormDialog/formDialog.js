...
export default function FormDialog(props) {
    ...
    let dialog = _jsxs("div", { className: dClass, "aria-label": props.ariaLabel, children: [_jsxs("div", { className: "vieolo-form-dialog__header", children: [_jsx(Typography, { type: "title-small", text: props.headerTitle }), props.headerRightComponent === 'close' &&
                        _jsx(IconButton, { icon: _jsx(CloseIcon, {}), onClick: () => {
                                if (!props.isLoading)
                                    props.onCancel();
                            }, color: 'primary', size: 'small', sm: {
                                size: 'medium'
                            }, "aria-label": props.ariaLabel ? `${props.ariaLabel} close button` : undefined }), (props.headerRightComponent && props.headerRightComponent !== 'close') &&
                ...
                _jsxs("div", { className: "vieolo-form-dialog__footer", style: (virtKeyboardOffset && props.smFullScreen) ? { bottom: `${virtKeyboardOffset}px` } : undefined, children: [_jsxs(Flex, { justifyContent: "start", alignItems: "center", columnGap: "half", children: [!props.removeCancelButton &&
                                ...
                                })] }), _jsxs(Flex, { alignItems: "center", justifyContent: "end", columnGap: "half", children: [(props.extraButtons || []).map((e, i) => {
                                    return _jsx(Button, { color: e.color, text: e.text, onClick: e.onClick, ariaLabel: getButtonAriaLabel(props.headerTitle, e.text, props.ariaLabel, e), disabled: props.isLoading, height: footerButtonSize, emphasis: e.emphasis, borderRadius: e.borderRadius, startIcon: e.startIcon }, `form_dialog_extra_button_button_${i}`);
