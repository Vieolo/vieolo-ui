...
export default function DateTimePicker(props) {
    var _a;
    return _jsxs("div", Object.assign({ className: `vieolo-date-time-picker ${props.disabled ? "disabled" : ''}` }, { children: [_jsx("div", Object.assign({ className: "vieolo-date-time-picker__label-container" }, { children: _jsx("label", Object.assign({ htmlFor: "" }, { children: props.label }), void 0) }), void 0),
            _jsxs("div", Object.assign({ className: "vieolo-date-time-picker__input-container" }, { children: [_jsx(DatePicker, { onDateSelect: props.onDateSelect, includeWeek: props.includeWeek, onWeekSelect: props.onWeekSelect, selectedDate: props.selectedDate, selectedWeek: props.selectedWeek, showSelectedWeek: props.showSelectedWeek, buttonComponent: _jsxs("div", Object.assign({ className: "vieolo-date-time-picker__input-container__date-picker-button" }, { children: [_jsxs("div", { children: [props.selectedDate &&
                    ...
                    _jsx(TimePicker, { onChange: props.onTimeChange, value: props.timeValue }, void 0)] }), void 0)] }), void 0);
}
