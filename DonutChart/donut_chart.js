...
export default function DonutChart(props) {
    ...
    useEffect(() => {
        ...
        let width = ((_a = ref.current) === null || _a === void 0 ? void 0 : _a.offsetWidth) || props.width || 400;
        ...
        svg.append("g")
            ...
            .join("path")
            .attr("fill", d => {
            if (!hasSelected && finalData[d.index] && finalData[d.index].color)
                return "";
            ...
            .attr("class", d => {
            if (!hasSelected && finalData[d.index] && finalData[d.index].color)
                return `fill-color--${finalData[d.index].color}-normal`;
            return '';
        })
            .attr("d", arc)
            .on("click", (e, d) => {
    ...
    return _jsx("div", { className: `vieolo-donut-chart ${props.disabled ? "disabled" : ""}`, ref: ref });
}
