...
export default function SubNavbarRow(props) {
    ...
    return _jsx("div", { className: "vieolo-sub-navbar-row", children: _jsxs(GridContainer, { className: "padding-horizontal--one height--pc-100", children: [_jsx(Grid, { xl: ((12 - midCol) / 2), className: "height--pc-100", children: _jsxs(Flex, { alignItems: "center", columnGap: "half", className: "height--pc-100", children: [!props.removeBackButton &&
