...
export default function List(props) {
    ...
    return _jsxs("div", Object.assign({ className: "global-list", style: { height: props.height } }, { children: [_jsx("div", Object.assign({ className: "center-by-flex-row" }, { children: _jsx(TypographyTitleMedium, { text: props.title, className: "margin-vertical--10" }, void 0) }), void 0),
            props.enableSearch &&
