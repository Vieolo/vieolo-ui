...
export default function PageFrame(props) {
    ...
    return _jsxs("div", { className: "vieolo-page-frame", children: [props.navbar &&
                ...
                _jsx(NavDrawer, { state: drawerOpen ? "open" : 'closed', mainItems: props.drawer.mainItems, bottomItems: props.drawer.bottomItems, topContent: props.drawer.topContent, onDrawerClose: () => setDrawerOpen(false) }), props.children] });
}
