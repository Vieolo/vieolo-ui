...
export default function TimeInput(props) {
    return _jsx(InputSet, { label: props.label || '', ariaLabel: props.ariaLabel || props.label, disabled: props.disabled, tip: props.tip, error: (props.optional && !props.value.trim()) ? false : parseInputTimeToCustomDate(props.value)[0] === null, onChange: v => {
