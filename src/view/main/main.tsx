...
export default function MainPage(props: {}): JSX.Element {
  ...
  let [selectedDataOptions, setSelectedDataOptions] = useState<any>(
    null as any
  );
  ...
  return (
    <div className="main-page">
      ...
      <div className="component-state-display">
        {selectedData != null && content != null && <div>{content}</div>}
      </div>
    </div>
  );
}
