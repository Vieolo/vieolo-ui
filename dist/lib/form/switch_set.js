...
export default function SwitchSet(props) {
    return _jsxs("div", Object.assign({ className: `vieolo-switch-set${props.disabled ? ' disabled' : ''}` }, { children: [_jsxs("div", Object.assign({ className: "vieolo-switch-set__title-container", onClick: () => props.onChange(!props.on) }, { children: [_jsx(TypographyParagraphLarge, { text: props.title }, void 0),
                    props.subtitle &&
