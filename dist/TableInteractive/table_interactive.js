            ...
            props.rows.map((row, i) => {
                return _jsx("div", Object.assign({ className: "vieolo-table-interactive__content-row", style: { gridTemplateColumns: props.columnGrid }, "aria-label": `row ${i + 1}` }, { children: row.map((r, ri) => {
                        ...
                        if (typeof r.value === 'string' || typeof r.value === 'number')
                            finalNode = _jsx(Typography, { text: typeof header === 'string' ? r.value.toString() : header.formatter(r.numericalValue || r.value) }, void 0);
...
function BottomRow(props) {
    ...
    return _jsx("div", Object.assign({ className: `vieolo-table-interactive__bottom-row` }, { children: (props.selectedCells.length > 0 && !isNaN(props.numericTotal) && props.header) &&
            _jsxs(Flex, Object.assign({ direction: 'row', alignItems: 'center', className: 'height--pc-100 padding-horizontal--one', justifyContent: 'space-between' }, { children: [_jsx(Typography, { type: 'paragraph-small', text: `Count: ${props.selectedCells.length}`, fontWeight: 'bold' }, void 0),
                    _jsx(Typography, { type: 'paragraph-small', text: `Average: ${format(average)}`, fontWeight: 'bold' }, void 0),
                    _jsx(Typography, { type: 'paragraph-small', text: `Total: ${format(props.numericTotal)}`, fontWeight: 'bold' }, void 0)] }), void 0) }), void 0);
}
