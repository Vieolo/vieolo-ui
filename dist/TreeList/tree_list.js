...
function SingleParent(props) {
    ...
    return _jsxs(Card, { className: "vieolo-tree-list-item", padding: "none", children: [props.item.group &&
                _jsx(Card, { ...(props.item.group.card || {}), className: "margin-top--one margin-bottom--half", children: _jsx(Typography, { text: props.item.group.title, type: 'title-small' }) }), _jsxs(Flex, { alignItems: "center", children: [hasChildren &&
